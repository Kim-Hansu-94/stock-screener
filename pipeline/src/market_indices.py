...
_US_INDEXES = [
    ...
    ("나스닥", "^IXIC"),
    ("S&P500", "^GSPC"),
    # 490590 매수 체크(FOMC 이후 금리 급등 감지)용. ^TNX는 CBOE 10년물 국채 수익률
    # 지수라 값이 수익률(%)의 10배로 온다 — 4.50%가 45.00으로 저장된다. 화면에서
    # 표시할 때 반드시 10으로 나눌 것 (frontend/lib/etfEntryCheck.ts 참고).
    ("미국10년물", "^TNX"),
]
